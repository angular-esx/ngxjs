...
describe('NgxConnectedPositionStrategy', () => {
  ...
  let _strategy: INgxConnectedPositionStrategy;
  let _positionStrategyService: INgxPositionStrategyService;
  let _overlayService: INgxOverlayService;
  ...
  describe('onPositionChange with scrollable view properties', () => {
    ...
    (zone: NgZone,
      ...
      renerService: INgxRenderService
    ) => {
