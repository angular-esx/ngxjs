...
import { INgxConnectedPositionStrategy } from './connected-position-strategy.interface';
...
export class NgxConnectedPositionStrategy implements INgxConnectedPositionStrategy {
  ...
  */
  ...
  apply (): void {
    if (!this._overlayRef) {
      throw new Error('You must attack INgxOverlayRef to NgxGlobalPositionStrategy before calling apply().');
    }
